...
pub(super) fn ldy_set_status(cpu: &mut CPU) {
...
pub(super) fn ldy_immediate(cpu: &mut CPU) {
...
/// cycles: 3
/// flags affected: N and Z
pub(super) fn ldy_zero_page(cpu: &mut CPU) {
...
/// cycles: 4
/// flags affected: N and Z
pub(super) fn ldy_zero_page_x(cpu: &mut CPU) {
...
/// cycles: 4
/// flags affected: N and Z
pub(super) fn ldy_absolute(cpu: &mut CPU) {
...
/// flags affected: N and Z
pub(super) fn ldy_absolute_x(cpu: &mut CPU) {
...
mod tests {
    use super::super::{
        ...
        OPCODE_LDY_IMM, OPCODE_LDY_ZPG, OPCODE_LDY_ZPX, UNRESERVED_MEMORY_ADDR_START,
    };
