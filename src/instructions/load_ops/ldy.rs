...
/// cycles: 2
/// flags affected: N,Z
pub(crate) fn ldy_immediate(cpu: &mut CPU) {
...
/// cycles: 3
/// flags affected: N,Z
pub(crate) fn ldy_zero_page(cpu: &mut CPU) {
...
/// cycles: 4
/// flags affected: N,Z
pub(crate) fn ldy_zero_page_x(cpu: &mut CPU) {
...
/// cycles: 4
/// flags affected: N,Z
pub(crate) fn ldy_absolute(cpu: &mut CPU) {
...
/// flags affected: N,Z
pub(crate) fn ldy_absolute_x(cpu: &mut CPU) {
