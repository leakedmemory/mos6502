...
/// cycles: 3
/// flags affected: none
pub(crate) fn stx_zero_page(cpu: &mut CPU) {
...
/// cycles: 4
/// flags affected: none
pub(crate) fn stx_zero_page_y(cpu: &mut CPU) {
...
/// cycles: 4
/// flags affected: none
pub(crate) fn stx_absolute(cpu: &mut CPU) {
...
mod tests {
    ...
    fn stx_zero_page_test() {
        ...
        memory.write(Opcode::STXZpg as u8, MEM_OFFSET);
        memory.write(0x42, MEM_OFFSET + 1);
        memory.write(Opcode::STXZpg as u8, MEM_OFFSET + 2);
        memory.write(0x57, MEM_OFFSET + 3);
        memory.write(Opcode::STXZpg as u8, MEM_OFFSET + 4);
        ...
        assert_eq!(cpu.memory.read(0x42), cpu.x);
        ...
        cpu.x = 0x00;
        cpu.execute_next_instruction();
        assert_eq!(cpu.memory.read(0x57), cpu.x);
        ...
        cpu.x = 0x80;
        cpu.execute_next_instruction();
        assert_eq!(cpu.memory.read(0x69), cpu.x);
    ...
    fn stx_zero_page_y_test() {
        ...
        let mut memory = Memory::new();
        memory.write(Opcode::STXZpy as u8, MEM_OFFSET);
        memory.write(0x42, MEM_OFFSET + 1);
        memory.write(Opcode::STXZpy as u8, MEM_OFFSET + 2);
        memory.write(0x57, MEM_OFFSET + 3);
        memory.write(Opcode::STXZpy as u8, MEM_OFFSET + 4);
        memory.write(0x69, MEM_OFFSET + 5);
        ...
        cpu.x = 0x32;
        cpu.execute_next_instruction();
        assert_eq!(cpu.memory.read(Y.wrapping_add(0x42).into()), cpu.x);
        assert_eq!(cpu.pc - init_pc, BYTES);
        assert_eq!(cpu.cycles - init_cycles, CYCLES);
        assert_eq!(cpu.status, CPU_DEFAULT_STATUS);
        ...
        cpu.x = 0x00;
        cpu.execute_next_instruction();
        assert_eq!(cpu.memory.read(Y.wrapping_add(0x57).into()), cpu.x);
        assert_eq!(cpu.pc - pc_after_first_exec, BYTES);
        assert_eq!(cpu.cycles - cycles_after_first_exec, CYCLES);
        assert_eq!(cpu.status, CPU_DEFAULT_STATUS);
        ...
        cpu.x = 0x80;
        cpu.execute_next_instruction();
        assert_eq!(cpu.memory.read(Y.wrapping_add(0x69).into()), cpu.x);
        assert_eq!(cpu.pc - pc_after_second_exec, BYTES);
        assert_eq!(cpu.cycles - cycles_after_second_exec, CYCLES);
        assert_eq!(cpu.status, CPU_DEFAULT_STATUS);
    }
    ...
    fn stx_absolute_test() {
        ...
        let mut memory = Memory::new();
        memory.write(Opcode::STXAbs as u8, MEM_OFFSET);
        memory.write(0x28, MEM_OFFSET + 1);
        memory.write(0x80, MEM_OFFSET + 2);
        memory.write(Opcode::STXAbs as u8, MEM_OFFSET + 3);
        memory.write(0x97, MEM_OFFSET + 4);
        memory.write(0x26, MEM_OFFSET + 5);
        memory.write(Opcode::STXAbs as u8, MEM_OFFSET + 6);
        ...
        cpu.x = 0x32;
        cpu.execute_next_instruction();
        assert_eq!(cpu.memory.read(0x8028), cpu.x);
        assert_eq!(cpu.pc - init_pc, BYTES);
        assert_eq!(cpu.cycles - init_cycles, CYCLES);
        assert_eq!(cpu.status, CPU_DEFAULT_STATUS);
        ...
        cpu.x = 0x00;
        cpu.execute_next_instruction();
        assert_eq!(cpu.memory.read(0x2697), cpu.x);
        assert_eq!(cpu.pc - pc_after_first_exec, BYTES);
        assert_eq!(cpu.cycles - cycles_after_first_exec, CYCLES);
        assert_eq!(cpu.status, CPU_DEFAULT_STATUS);
        ...
        cpu.x = 0x80;
        cpu.execute_next_instruction();
        assert_eq!(cpu.memory.read(0x5570), cpu.x);
        assert_eq!(cpu.pc - pc_after_second_exec, BYTES);
        assert_eq!(cpu.cycles - cycles_after_second_exec, CYCLES);
        assert_eq!(cpu.status, CPU_DEFAULT_STATUS);
    }
